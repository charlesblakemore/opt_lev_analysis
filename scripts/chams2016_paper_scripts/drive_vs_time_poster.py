...
if( True ):
    ...
    plt.savefig("resp_vs_time_poster.pdf")
   ...
   ## now do the inset plot
    ...
    iax.set_position(matplotlib.transforms.Bbox(np.array([[0.125,0.125],[0.725,0.9]])))
    iax2.set_position(matplotlib.transforms.Bbox(np.array([[0.725,0.125],[0.9,0.9]])))
    ...
    plt.savefig("resp_vs_time_poster_zoom.pdf")
