...
path = ["/home/dmartin/analyzedData/20190626/wobble/new/wobble_after_spindown_2.npy"]
...
if no_offset:
	plt.plot(x ,sqrt(x,*popt),label="meas {}, {} $e\cdot\mu m$".format(meas_name_2,round(dipole,3)))
	...
	plt.legend()
	if save:
		plt.savefig(out_path + 'wobble_meas_{}_{}_{}.png'.format(date,meas_names[j],offset_state),dpi = 250)
plt.show()	
