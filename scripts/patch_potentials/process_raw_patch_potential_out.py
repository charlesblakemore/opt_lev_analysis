...
#path = '/data/comsol_outputs/patch_potentials/patch_pot_2um_1Vrms_150um-deep-patches.txt'
#path = '/data/comsol_outputs/patch_potentials/patch_pot_2um_1Vrms_150um-deep-patches_4mmBC.txt'
#path = '/data/comsol_outputs/patch_potentials/patch_pot_2um_1Vrms_250um-deep-patches.txt'
#path = '/data/comsol_outputs/patch_potentials/patch_pot_2um_0Vrms_bias-1Vdc.txt'
path = '/data/comsol_outputs/patch_potentials/patch_pot_2um_0Vrms_bias-1Vdc_8um-cant.txt'

#path = '/data/comsol_outputs/patch_potentials/patch_pot_2um_1Vrms_150um-deep-patches_4mmBC_seed100.txt'



paths = []
base_path ='/data/comsol_outputs/patch_potentials/patch_pot_2um_1Vrms_150um-deep-patches_4mmBC_seed'
for seed in np.linspace(0,2000,21):
    paths.append(base_path + str(int(seed)) + '.txt')


paths = []
base_path = '/data/comsol_outputs/patch_potentials/superposition_test/'
base_path += 'patch_pot_2um_1Vrms_150um-deep-patches_4mmBC'
paths.append(base_path + '_FINGER.txt')
paths.append(base_path + '_PATCH.txt')
paths.append(base_path + '_PATCH-FINGER.txt')
...
for pathind, path in enumerate(paths):
    ...
    if pathind == 0:
        field_finger = np.copy(field)
    if pathind == 1:
        field_patch = np.copy(field)
    if pathind == 2:
        resids = ((field_finger + field_patch) - field) / field
        plt.hist(resids.flatten(), bins=50, range=(-.01,.01))
        plt.show()
