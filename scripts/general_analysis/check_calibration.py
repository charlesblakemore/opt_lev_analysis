...
charge_cal = [['/data/20170629/bead6/discharge_fine'], 'Cal', 0]
...
charge_cal_dir_obj.load_step_cal('./calibrations/step_cal_20170707.p')

#for fobj in charge_cal_dir_obj.fobjs:
#    fobj.close_dat()

charge_cal_dir_obj.load_H("./trans_funcs/Hout_20170707.p")
...
therm_path = '/data/20170707/bead5/1_5mbar_nocool.h5'


charge_cal_dir_obj.thermal_cal_file_path = therm_path
charge_cal_dir_obj.thermal_calibration(temp=temp)
if plot:
...
therm_facs = charge_cal_dir_obj.thermal_cal_fobj.get_thermal_cal_facs(temp=temp)
