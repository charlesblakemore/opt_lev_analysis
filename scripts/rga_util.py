...
def get_leak_m0(main_gas, gas_pp1, gas_pp2, remove_neg_diffs=False, sens_err=0.1):
    ...
    extracted_gas_keys = gas_pp1.keys()
    diffs = {}
    max_diff = 0
    ...
    for key in extracted_gas_keys:
        isotopes = diffs_norm_cal[key].keys()
        for isotope in isotopes:
